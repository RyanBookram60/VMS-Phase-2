...
public class VehicleManager {
    ...
    public String addVehicle(String info) {
        ...
        try {
            if (splitInfo.length != 8) {
                return "Invalid format. Ensure 8 attributes are entered and are separated by dashes with no spaces.\nFormat: VIN-Make-Model-Price-Trans-Miles-Color-Drivetrain";
            }
            else {
    ...
    public String updateVehicle(String info) {
        ...
        try {
            ...
            output = "Invalid format. Ensure 8 attributes are entered and are separated by dashes with no spaces.\nFormat: VIN-Make-Model-Price-Trans-Miles-Color-Drivetrain";
        }
        return output;
    }
